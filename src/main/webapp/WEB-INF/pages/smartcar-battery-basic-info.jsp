...
<div class="wrap-fluid">
  <div class="container-fluid paper-wrap bevel tlbr">
    ...
    <ul id="breadcrumb">
      ...
      <li><a href="#" title="Sample page 1">Info</a>
      </li>
      <li><i class="fa fa-lg fa-angle-right"></i>
      </li>
      <li><a href="#" title="Sample page 1">battery</a>
      </li>
      <li class="pull-right">
          ...
          <div class="nest" id="FootableClose">
            ...
            <div class="body-nest" id="Footable">
              ...
              <table class="table-striped footable-res footable metro-blue" data-page-size="6">
                ...
                <c:forEach var="battery" items="${listBattery}" varStatus="state">
                  <tr>
                    <td>${battery.getBaterryId()}</td>
                    <td>${battery.getBaterryId()} </td>
                    <td>${battery.getBaterryId()} </td>
                    <td>${battery.getCratedate()} </td>
                    <td>${battery.getAmpere()} </td>
                    <td>${battery.getVolt()} </td>
                    <td>${battery.getStatus()} </td>
